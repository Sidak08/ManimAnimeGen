...
class TrigBasics(Scene):
    def construct(self):
        # Create a simpler demonstration focusing on the Pythagorean identity
        
        # Title
        title = Text("Trigonometric Identities", font_size=60)
        ...
        # Proof with values
        proof = VGroup(
            Tex("\\left(\\frac{\\sqrt{2}}{2}\\right)^2 + \\left(\\frac{\\sqrt{2}}{2}\\right)^2 = \\frac{1}{2} + \\frac{1}{2} = 1", font_size=36)
        )
        ...
        # Point and angle
        self.next_section("PointAndAngle")
        self.play(
